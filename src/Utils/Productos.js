const productos = [
    ...
    },
    {
        ...
        detail: 'T’Challa es el alias “civil” de Black Panther. Es el rey de la nación africana de Wakanda. Estuvo muchos años casado con Ororo (Storm) hasta los acontecimientos de Avengers vs X-Men. Sus habilidades van desde la fuerza sobrehumana hasta los súper reflejos, sin embargo, es su gran astucia (de pantera) lo que lo vuelve distintivo.'
    },
    {
        id: '8',
        nombre: 'Anakin',
    ...
    },
    {
        ...
        detail: 'Darth Vader, el famoso Lord Sith, apareció por primera vez en las pantallas de cine en Star Wars: Episodio IV – Una Nueva Esperanza (1977). Pronto se reveló que era un villano despiadado, decidido a cazar a los enemigos del Imperio. Bajo la instrucción del malvado Emperador Galáctico Palpatine.'
    },
    {
        id: '12',
        nombre: 'HanSolo',
        ...
        detail: 'De contrabandista canalla pasó a ser héroe rebelde. Han Solo™ siempre es valiente y audaz en la batalla.Han Solo ha sido un personaje clave en la saga Star Wars™ desde el lanzamiento en 1977 de Star Wars'
    },
    {
        id: '13',
        nombre: 'Luke',
    ...
    },
    {
        ...
        detail: 'The Mandalorian es un famoso cazarrecompensas a quien contrata un misterioso cliente para capturar a un “activo” que resulta ser el Niño. Descubrimos que el Mandaloriano es un huérfano adoptado de pequeño por una tribu de guerreros del planeta Mandalore, quienes lo criaron e instruyeron en sus particulares costumbres.'
    }
]
